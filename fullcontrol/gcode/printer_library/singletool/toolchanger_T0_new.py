...
def set_up(user_overrides: dict):
    ...
    starting_procedure_steps.append(ManualGcode(
        text='; generated by FullControl\n'))
    starting_procedure_steps.append(PrinterCommand(id='home'))
    starting_procedure_steps.append(PrinterCommand(id='mesh_bed_probe'))
    starting_procedure_steps.append(ManualGcode(text='; Take current Tool\nT0'))
    ...
    starting_procedure_steps.append(ManualGcode(text='M98 P"0:/macros/brush_new.g" ; Clean Nozzle via Macro'))
